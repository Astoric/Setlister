...
<template>
    ...
    <!-- Main Page Container with Gradient that always fills the viewport -->
    <div class="relative min-h-screen w-full overflow-hidden">
        <div
            class="absolute inset-0 z-0 bg-gradient-to-br from-emerald-400 via-emerald-500 to-teal-600"
            style="min-height: 100vh"></div>
        <div
            class="relative z-10 flex flex-col justify-center items-center min-h-screen py-4 px-2 sm:py-8 sm:px-6">
            <Card
                        ...
                        <form
                            ...
                            <div class="space-y-1 sm:space-y-2">
                                ...
                                <InputError
                                    class="mt-2"
                                    :message="
                                        getError(registerData, 'password')
                                    " />
                            </div>
