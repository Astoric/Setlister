...
<template>
    <section>
        ...
        <Card class="bg-[#191919] border-gray-600 max-w-full">
            <CardContent class="p-4 sm:p-6 w-full">
                <div
                    class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-4 w-full">
                    ...
                    <div
                        class="flex flex-row sm:flex-col gap-2 w-full sm:w-auto justify-end sm:justify-start">
                        <Button
                            v-if="isSpotifyAccountConnected"
                            @click="redirectToSpotifyAuth"
                            variant="outline"
                            class="border-gray-600 text-gray-300 hover:bg-gray-700 hover:text-white transition-all duration-200 w-full sm:w-auto">
                            Re-Connect
                        </Button>
                        <Button
                            v-else
                            @click="redirectToSpotifyAuth"
                            class="bg-green-500 hover:bg-green-600 transition-all duration-200 w-full sm:w-auto">
